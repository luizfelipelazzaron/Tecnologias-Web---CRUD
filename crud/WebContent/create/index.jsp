...
<html lang="en">
  ...
  <div class="container d-flex flex-column align-items-center justify-content-center">
    <h1 class="display-4 mt-5">Create New Task</h1>
    	
		<div class="bg-white p-3 form-group input-group input-group-sm mb-3">
    <form action="./Create" class="form-group input-group input-group-sm mb-3"  method="post">
			<div class="input-group mb-3">
				  <div class="input-group-prepend">
				    <label class="input-group-text">Title</label>
				  </div>
				  <input type="text" name="taskTitle" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
			</div>
			...
			<input type="submit" name="login" value="Create" class="btn btn-primary btn-lg btn-block">
